...
- (void)viewDidLoad
{
    ...
    self.stops = [[MetrolinkDatabase database] stopsForRoute:routeID];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    StopNameAndStopTime *stop = [self.stops objectAtIndex: indexPath.row];
    cell.textLabel.text = stop.stop_name;
    cell.detailTextLabel.text = stop.stop_time;
    return cell;
}
